@extends('index')
@section('content')
	<div class="row" id="zapiszemy_cie_na_twoj_bieg">
		<div class=" col-sm-1 col-md-3 col-lg-3 col-g-4"></div>
		<div class="col-xs-12 col-sm-5 col-md-3 col-lg-3 col-g-2">
		...
		<div class="col-xs-8 col-sm-8 col-md-8 col-lg-6 col-g-6">
			<div class="row" id="kroczki">
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-g-4" >
					...
					<p>Utwórz konto na ArunZ.eu i powiedz nam czym jesteś zainteresowany</p>
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-g-4" >
					...
					<p>Napisz do nas za pomocą aplikacji społecznościowej, której używasz i powiedz gdzie chcesz wystartować</p>
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-g-4" >
					...
					<p>Odwiedzaj Nas na ArunZ.eu i śledź informacje o twoim biegu oraz przydatne informacje o trasie</p>
	...
	<div class="row" id="rozwiazujemy_za_ciebie">
		...
		<div style="margin:0 auto;padding-top:60px">
			<div style="text-align:center">
				<div style="margin-bottom:30px;">
					...
					<span class="normal_text"> już dziś</span>
				</div>
