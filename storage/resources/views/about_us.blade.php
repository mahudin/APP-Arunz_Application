			...
			<div class="row il  zyskasz">
				...
				<div class="row il " id="portrety">
					...
					<div class="col-md-2 col-sm-2 col-lg-2 col-g-2 kolko_portret">
						<img src="materials/portrety/ArunZ_O_nas_Jan_B.png" class="kolko_portret"/>
						<h4>Jasiek</h4>
			...
			<!--div  id="dolacz_do_nas" style="background-image:url({{ URL::asset('materials/road.jpg') }});">
				<div style="margin:0 auto;">
					<div style="text-align:center"><br/>
						<h4>Daj Nam znać co możemy zmienić</h4>
						 <textarea rows="8" style="min-width:300px">
zostaw opinie/ komentarz/ pytanie
</textarea>
					</div>
				</div>
			</div-->
