...
class MailController extends Controller
{
    ...
    public function Tresc(string $login, string $haslo, string $token)
	{
	    ...
	    <html>
	        ...
	        <body>
	        <img style="margin:0 auto;text-align:center" src="http://www.arunz.eu/preview/logo_ArunZ.svg"/><br/><br/>
	        <h1 style="font-family: \"Open Sans\", sans-serif!important;">Witaj, '.$login.'</h1><br/>
	        <p>
                Wysłaliśmy Ci tę wiadomość, ponieważ otrzymaliśmy żadanie zmiany hasła do Twojego konta ArunZ. Jeśli nie chcesz zmieniać
                swojego hasła, możesz zignorować tę wiadomość.
                <br/><br/>
                Aby wprowadzić nowe hasło, kliknij poniższy odnośnik
                <a href="http://arunz.pl/remind_password/'.$token.'">http://arunz.pl/remind_password/'.$token.'</a><br/>

                <br/><br/>
                Jeśli kliknięcie nie przyniesie spodziewanego efektu, skopiuj adres do schowka i wklej go w pasku adresu przeglądarki.

	        <br/><br/>
            Swoje hasło możesz zmienić w dowolnej chwili na stronie Profil w serwisie www.arunz.pl
            <br/><br/>
            Udanych startów!<br/>
    ...
    public function check_token_remind_pass($id)
	{
        ...
        if(isset($token[0]) && $token[0]->passkey == $id){
            ...
            return view("error_remind_password");
        }
    }
}
