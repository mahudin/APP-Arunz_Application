		...
		<div style="text-align: center;" style="margin: 0 auto">
			...
			<div class="row">
				...
				<div class="row" id="o_mnie">
					...
					<div class="form-group">
						<label>Data ważności:<br/><div id="error_datevalue"></div>
							<input type="text" class="datepicker form-control" id="data_waznosci" name="data_waznosci" />
						</label>
					</div>
						<label>CVV/CVC:<br/><div id="error_codecard"></div>
							<input type="text" class="form-control" value="" max="4" name="cvv/cvc" id="cvv_cvc" />
						</label><br/>
					<div class="form-group">
						<label>Imie:<br/>
