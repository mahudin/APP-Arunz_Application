...
<html>
    <head>
		...
		<link rel="stylesheet" href="{{ URL::asset('css/showup.css') }}">
		...
		<script type="text/javascript" src="<?php echo URL::asset('js/showup.js'); ?>"></script>
    ...
    <body>
		<div class="panel-body">
			<div>
				<header class="navbar nav-down navbar-inverse navbar-fixed-top bs-docs-nav navbar-show" role="banner">
				    <div class="container">
	...
	<div class="popup" style="z-index:10000;" data-popup="popup-1">
		...
		<div class="popup" style="z-index:99;" data-popup="popup-4">
			<div class="popup-inner" id="popek4">
				<h3 id="czwarty_naglowek" style="opacity: 1.0;margin-top:-15px;">O nas:</h3>
				<p id="opis_gorny4">
				<form id="additional_data_user" action="update_profile_additional" action="post">
					<div class="form-group"  style="min-width:100%;">
						<label id="label_walking_for">Biegam od </label><br/>
				...
				<div class="form-group" style="min-width:100%;">
					<label id="label_walking_count">Miesięcznie przebiegam </label><br/>
				...
				<div class="form-group" style="min-width:100%;">
					<label id="label_walking_because">Biegam ponieważ </label><br/>
				...
				<div class="form-group" style="min-width:100%;">
					<label id="label_shirt_size">Twój rozmiar koszulki </label><br/>
						<select id="shirt_size" name="shirt_size" value="<?php echo isset($user->shirt_size)?$user->shirt_size:"";?>"  class="form-control" style="width:100%;">
							<option>XS</option>
							<option>S</option>
							<option>M</option>
							<option>L</option>
				...
				<div class="form-group" style="min-width:100%;">
					<label id="label_my-events">Wydarzenia, w których brałem udział <br/></label>
						<div class="ui-widget"  style="z-index:99;">
							<input id="wydarzenia_search2" class="form-control"/>
						</div><br/>
						<textarea id="my-events" class="form-control" style="min-width:100%;height:100px;"></textarea>

				</div>
				<?php if(isset($user->id) && $user->id >0){ ?>
					<input type="hidden" id="idu" class="form-control" value="{{$user->id}}"/>
				<?php } ?>
			...
			<div class="container" style="margin:0 auto; padding:10px;">
				<div class="row row-bottom-padded-md" style="margin-right: 15px!important;">
							...
							<ul class="fh5co-links" style="color:white!important;font-size:10pt">
								<li>
										<div style="display:inline;float:left;">
											<img src="{{ URL::asset('materials/portrety/jasiek_stopka_square.png') }}" class="social-icon"/>
										</div>
